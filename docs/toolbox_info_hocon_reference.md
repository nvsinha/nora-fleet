...
This document describes the specifications for the toolbox info file used in the **nora-fleet** system. This file
allows you to extend or override the default tools shipped with the nora-fleet library.

The **nora-fleet** system uses the HOCON (Human-Optimized Config Object Notation) format for data-driven configuration. HOCON
...
[toolbox_info.hocon](../nora_fleet/internals/run_context/langchain/toolbox/toolbox_info.hocon).
...
To customize the set of tools available to agents in the nora-fleet system, you can provide your own toolbox info file.
