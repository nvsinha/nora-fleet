...
from nora_fleet.client.concierge_session_factory import ConciergeSessionFactory
...
class AgentCli:
    ...
    def chat(self):
        ...
        if self.args.first_prompt_file is not None:
            ...
            #           which actually does the path traversal check. Static analysis does not
...
"""
    ...
    def add_args(self, arg_parser: argparse.ArgumentParser):
        ...
        # How will we connect to nora-fleet?
        group = arg_parser.add_argument_group(title="Session Type",
                                              description="How will we connect to nora-fleet?")
