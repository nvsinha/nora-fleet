...
class ExternalAgentParsing:
    ...
    def is_mcp_tool(tool_ref: Union[str, Dict[str, Any]]) -> bool:
        ...
        # This may change in the future when Nora Fleet supports other protocals like A2A.
        ...
        # Heuristic to distinguish an MCP server URI from a Nora Fleet external agent URL:
