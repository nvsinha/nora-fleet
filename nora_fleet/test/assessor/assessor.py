...
from nora_fleet.client.simple_one_shot import SimpleOneShot
from nora_fleet.interfaces.agent_session import AgentSession
from nora_fleet.test.assessor.assessor_assert_forwarder import AssessorAssertForwarder
from nora_fleet.test.driver.data_driven_agent_test_driver import DataDrivenAgentTestDriver
...
class Assessor:
    ...
    def add_args(self, arg_parser: argparse.ArgumentParser):
        ...
        arg_parser.add_argument("--assessor_agent", type=str, default=None,
                                help="""
The assessor agent to use. A default of None implies use of nora-fleet stock assess_failure.hocon
""")
